...
class Config:
    ...
    # def __init__(self, param=None, filename='config.json'):
    ...
    #         self._state = True
    #
    # def get(self, section='general', param=None):
    #     r = 'undefined'
    #     if not self.status():
    #         return r
    ...
    #     return r
    #
    # def set(self, section='general', param=None, value=None):
    #     key_found = False
    #     if not self.status():
    #         log.error('Config file %s is not open.' % self._filename)
    #         return
    #     if self._p_list is not None and param is not None:
    #         if value is None:
    #             value = param
    #             param = section
    #             section = 'general'
    #         for sec in self._p_list:
    #             try:
    #                 if sec.get(section):
    #                     sec[section].update({param: value})
    #                     key_found = True
    #             except Exception:
    #                 pass
    #     if not key_found:
    #         if self._p_list is None:
    #             self._p_list = [{section: {param: value}}]
    #             self._state = True
    #         else:
    #             self._p_list += [{section: {param: value}}]
    #     del section, param, value
    #
    # def open(self):
    #     try:
    #         with open(self._filename) as f:
    #             if os.stat(self._filename).st_size > 0:
    #                 self._p_list = json.load(f)
    #             self._state = True
    #     except Exception as e:
    #         # log.error('Error occurred while reading config file.'.format(e)) -- global log object doesn't exist yet
    #         print('    Error occurred while reading config file: {0}'.format(e))
    #
    # def save(self):
    #     f = None
    #     if self._p_list != [{}]:
    ...
    #             json.dump(self._p_list, f, indent=4)
    #         except Exception as e:
